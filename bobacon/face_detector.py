...
from bobacon.typing import Angle, BoundingBox, Detection, DownloadScope, DownloadSet, FaceLandmark5, InferencePool, ModelSet, Score, VisionFrame
	...
	return\
	{
		'retinaface':
		{
			'hashes':
			{
				'retinaface':
				{
					'url': resolve_download_url('models', 'retinaface_10g.hash'),
			...
			'sources':
			{
				'retinaface':
				{
					'url': resolve_download_url('models', 'retinaface_10g.onnx'),
		...
		'scrfd':
		{
			'hashes':
			{
				'scrfd':
				{
					'url': resolve_download_url('models', 'scrfd_2.5g.hash'),
			...
			'sources':
			{
				'scrfd':
				{
					'url': resolve_download_url('models', 'scrfd_2.5g.onnx'),
		...
		'yoloface':
		{
			'hashes':
			{
				'yoloface':
				{
					'url': resolve_download_url('models', 'yoloface_8n.hash'),
			...
			'sources':
			{
				'yoloface':
				{
					'url': resolve_download_url('models', 'yoloface_8n.onnx'),
