...
from bobacon.typing import Fps, OutputAudioEncoder, OutputVideoEncoder, OutputVideoPreset
...
def render() -> None:
	...
	OUTPUT_IMAGE_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(bobacon.choices.output_image_quality_range),
	...
	OUTPUT_AUDIO_ENCODER_DROPDOWN = gradio.Dropdown(
		...
		choices = bobacon.choices.output_audio_encoders,
	...
	OUTPUT_VIDEO_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(bobacon.choices.output_video_quality_range),
