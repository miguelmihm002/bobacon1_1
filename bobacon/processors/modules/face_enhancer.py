...
from bobacon.processors.typing import FaceEnhancerInputs, FaceEnhancerWeight
	...
	return\
	{
		'codeformer':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'codeformer.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'codeformer.onnx'),
		...
		'gfpgan_1.2':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.2.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.2.onnx'),
		...
		'gfpgan_1.3':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.3.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.3.onnx'),
		...
		'gfpgan_1.4':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.4.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gfpgan_1.4.onnx'),
		...
		'gpen_bfr_256':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_256.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_256.onnx'),
		...
		'gpen_bfr_512':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_512.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_512.onnx'),
		...
		'gpen_bfr_1024':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_1024.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_1024.onnx'),
		...
		'gpen_bfr_2048':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_2048.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'gpen_bfr_2048.onnx'),
		...
		'restoreformer_plus_plus':
		{
			'hashes':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'restoreformer_plus_plus.hash'),
			...
			'sources':
			{
				'face_enhancer':
				{
					'url': resolve_download_url('models', 'restoreformer_plus_plus.onnx'),
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend', 'face_enhancer_weight' ])
