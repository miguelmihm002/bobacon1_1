...
from bobacon import face_masker, state_manager, wording
from bobacon.common_helper import calc_float_step, calc_int_step
from bobacon.typing import FaceMaskRegion, FaceMaskType, FaceOccluderModel, FaceParserModel
...
def render() -> None:
	...
	with gradio.Row():
		FACE_OCCLUDER_MODEL_DROPDOWN = gradio.Dropdown(
			...
			choices = bobacon.choices.face_occluder_models,
		...
		FACE_PARSER_MODEL_DROPDOWN = gradio.Dropdown(
			...
			choices = bobacon.choices.face_parser_models,
