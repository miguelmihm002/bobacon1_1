...
from bobacon.typing import Angle, BoundingBox, DownloadScope, DownloadSet, FaceLandmark5, FaceLandmark68, InferencePool, ModelSet, Prediction, Score, VisionFrame
	...
	return\
	{
		'2dfan4':
		{
			'hashes':
			{
				'2dfan4':
				{
					'url': resolve_download_url('models', '2dfan4.hash'),
			...
			'sources':
			{
				'2dfan4':
				{
					'url': resolve_download_url('models', '2dfan4.onnx'),
		...
		'peppa_wutz':
		{
			'hashes':
			{
				'peppa_wutz':
				{
					'url': resolve_download_url('models', 'peppa_wutz.hash'),
			...
			'sources':
			{
				'peppa_wutz':
				{
					'url': resolve_download_url('models', 'peppa_wutz.onnx'),
		...
		'fan_68_5':
		{
			'hashes':
			{
				'fan_68_5':
				{
					'url': resolve_download_url('models', 'fan_68_5.hash'),
			...
			'sources':
			{
				'fan_68_5':
				{
					'url': resolve_download_url('models', 'fan_68_5.onnx'),
