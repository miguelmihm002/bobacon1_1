...
from bobacon1_1 import config, process_manager, wording
...
from bobacon1_1.face_helper import warp_face_by_face_landmark_5, categorize_age, categorize_gender
from bobacon1_1.face_store import get_reference_faces
from bobacon1_1.content_analyser import clear_content_analyser
from bobacon1_1.typing import Face, VisionFrame, UpdateProgress, ProcessMode, QueuePayload
from bobacon1_1.vision import read_image, read_static_image, write_image
from bobacon1_1.processors.frame.typings import FaceDebuggerInputs
from bobacon1_1.processors.frame import globals as frame_processors_globals, choices as frame_processors_choices
...
def debug_face(target_face : Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	if 'face-mask' in frame_processors_globals.face_debugger_items:
		...
		if 'box' in bobacon1_1.globals.face_mask_types:
			box_mask = create_static_box_mask(crop_vision_frame.shape[:2][::-1], 0, bobacon1_1.globals.face_mask_padding)
