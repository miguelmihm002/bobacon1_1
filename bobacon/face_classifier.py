...
from bobacon.typing import Age, DownloadScope, FaceLandmark5, Gender, InferencePool, ModelOptions, ModelSet, Race, VisionFrame
	...
	return\
	{
		'fairface':
		{
			'hashes':
			{
				'face_classifier':
				{
					'url': resolve_download_url('models', 'fairface.hash'),
			...
			'sources':
			{
				'face_classifier':
				{
					'url': resolve_download_url('models', 'fairface.onnx'),
