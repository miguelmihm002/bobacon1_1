...
from bobacon.processors.typing import AgeModifierDirection, AgeModifierInputs
...
from bobacon.vision import match_frame_color, read_image, read_static_image, write_image
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if has_execution_provider('coreml'):
		age_modifier.set_providers([ bobacon.choices.execution_provider_set.get('cpu') ])
