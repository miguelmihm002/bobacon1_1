...
from bobacon.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
	...
	return\
	{
		'clear_reality_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'clear_reality_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'clear_reality_x4.onnx'),
		...
		'lsdir_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'lsdir_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'lsdir_x4.onnx'),
		...
		'nomos8k_sc_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'nomos8k_sc_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'nomos8k_sc_x4.onnx'),
		...
		'real_esrgan_x2':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x2.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x2.onnx'),
		...
		'real_esrgan_x2_fp16':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x2_fp16.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x2_fp16.onnx'),
		...
		'real_esrgan_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x4.onnx'),
		...
		'real_esrgan_x4_fp16':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x4_fp16.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x4_fp16.onnx'),
		...
		'real_esrgan_x8':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x8.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x8.onnx'),
		...
		'real_esrgan_x8_fp16':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x8_fp16.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_esrgan_x8_fp16.onnx'),
		...
		'real_hatgan_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_hatgan_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'real_hatgan_x4.onnx'),
		...
		'span_kendata_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'span_kendata_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'span_kendata_x4.onnx'),
		...
		'ultra_sharp_x4':
		{
			'hashes':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'ultra_sharp_x4.hash'),
			...
			'sources':
			{
				'frame_enhancer':
				{
					'url': resolve_download_url('models', 'ultra_sharp_x4.onnx'),
