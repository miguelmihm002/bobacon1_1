	...
	return\
	{
		'ddcolor':
		{
			'hashes':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'ddcolor.hash'),
			...
			'sources':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'ddcolor.onnx'),
		...
		'ddcolor_artistic':
		{
			'hashes':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'ddcolor_artistic.hash'),
			...
			'sources':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'ddcolor_artistic.onnx'),
		...
		'deoldify':
		{
			'hashes':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify.hash'),
			...
			'sources':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify.onnx'),
		...
		'deoldify_artistic':
		{
			'hashes':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify_artistic.hash'),
			...
			'sources':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify_artistic.onnx'),
		...
		'deoldify_stable':
		{
			'hashes':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify_stable.hash'),
			...
			'sources':
			{
				'frame_colorizer':
				{
					'url': resolve_download_url('models', 'deoldify_stable.onnx'),
