...
from bobacon.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
...
from bobacon.face_selector import find_similar_faces, sort_and_filter_faces, sort_faces_by_order
...
from bobacon.model_helper import get_static_model_initializer
...
from bobacon.typing import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
	...
	return\
	{
		'blendswap_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'blendswap_256.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'blendswap_256.onnx'),
		...
		'ghost_1_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_1_256.hash'),
					'path': resolve_relative_path('../.assets/models/ghost_1_256.hash')
				},
				'embedding_converter':
				{
					'url': resolve_download_url('models', 'arcface_converter_ghost.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_1_256.onnx'),
					'path': resolve_relative_path('../.assets/models/ghost_1_256.onnx')
				},
				'embedding_converter':
				{
					'url': resolve_download_url('models', 'arcface_converter_ghost.onnx'),
		...
		'ghost_2_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_2_256.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_2_256.onnx'),
		...
		'ghost_3_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_3_256.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'ghost_3_256.onnx'),
		...
		'inswapper_128':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'inswapper_128.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'inswapper_128.onnx'),
		...
		'inswapper_128_fp16':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'inswapper_128_fp16.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'inswapper_128_fp16.onnx'),
		...
		'simswap_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'simswap_256.hash'),
					'path': resolve_relative_path('../.assets/models/simswap_256.hash')
				},
				'embedding_converter':
				{
					'url': resolve_download_url('models', 'arcface_converter_simswap.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'simswap_256.onnx'),
					'path': resolve_relative_path('../.assets/models/simswap_256.onnx')
				},
				'embedding_converter':
				{
					'url': resolve_download_url('models', 'arcface_converter_simswap.onnx'),
		...
		'simswap_unofficial_512':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'simswap_unofficial_512.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'simswap_unofficial_512.onnx'),
		...
		'uniface_256':
		{
			'hashes':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'uniface_256.hash'),
			...
			'sources':
			{
				'face_swapper':
				{
					'url': resolve_download_url('models', 'uniface_256.onnx'),
...
def forward_swap_face(source_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
	...
	if has_execution_provider('coreml') and model_type in [ 'ghost', 'uniface' ]:
		face_swapper.set_providers([ bobacon.choices.execution_provider_set.get('cpu') ])
