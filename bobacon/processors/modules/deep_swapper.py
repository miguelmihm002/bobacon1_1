...
from bobacon.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from bobacon.filesystem import in_directory, is_image, is_video, list_directory, resolve_relative_path, same_file_extension
from bobacon.processors import choices as processors_choices
from bobacon.processors.typing import DeepSwapperInputs, DeepSwapperMorph
from bobacon.program_helper import find_argument_group
from bobacon.thread_helper import thread_semaphore
from bobacon.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from bobacon.vision import conditional_match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
