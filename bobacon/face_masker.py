...
from bobacon.typing import DownloadScope, DownloadSet, FaceLandmark68, FaceMaskRegion, InferencePool, Mask, ModelSet, Padding, VisionFrame
	...
	return\
	{
		'xseg_1':
		{
			...
			'sources':
			{
				'face_occluder':
				{
					'url': resolve_download_url('models', 'xseg_1.onnx'),
		...
		'xseg_2':
		{
			...
			'sources':
			{
				'face_occluder':
				{
					'url': resolve_download_url('models', 'xseg_2.onnx'),
		...
		'bisenet_resnet_18':
		{
			...
			'sources':
			{
				'face_parser':
				{
					'url': resolve_download_url('models', 'bisenet_resnet_18.onnx'),
		...
		'bisenet_resnet_34':
		{
			'hashes':
			{
				'face_parser':
				{
					'url': resolve_download_url('models', 'bisenet_resnet_34.hash'),
			...
			'sources':
			{
				'face_parser':
				{
					'url': resolve_download_url('models', 'bisenet_resnet_34.onnx'),
...
def create_region_mask(crop_vision_frame : VisionFrame, face_mask_regions : List[FaceMaskRegion]) -> Mask:
	...
	region_mask = numpy.isin(region_mask.argmax(0), [ bobacon.choices.face_mask_region_set.get(face_mask_region) for face_mask_region in face_mask_regions ])
