...
from bobacon import face_landmarker, state_manager, wording
from bobacon.common_helper import calc_float_step
from bobacon.typing import FaceLandmarkerModel, Score
...
def render() -> None:
	...
	FACE_LANDMARKER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = bobacon.choices.face_landmarker_models,
	...
	FACE_LANDMARKER_SCORE_SLIDER = gradio.Slider(
		...
		step = calc_float_step(bobacon.choices.face_landmarker_score_range),
