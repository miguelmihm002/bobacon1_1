...
def get_test_jobs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'bobacon-test-jobs')
...
def get_test_examples_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'bobacon-test-examples')
...
def get_test_outputs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'bobacon-test-outputs')
