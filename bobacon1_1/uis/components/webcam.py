...
from bobacon1_1.audio import create_empty_audio_frame
from bobacon1_1.common_helper import is_windows
from bobacon1_1.content_analyser import analyse_stream
from bobacon1_1.filesystem import filter_image_paths
from bobacon1_1.typing import VisionFrame, Face, Fps
from bobacon1_1.face_analyser import get_average_face
from bobacon1_1.processors.frame.core import get_frame_processors_modules, load_frame_processor_module
from bobacon1_1.ffmpeg import open_ffmpeg
from bobacon1_1.vision import normalize_frame_color, read_static_images, unpack_resolution
from bobacon1_1.uis.typing import StreamMode, WebcamMode
from bobacon1_1.uis.core import get_ui_component, get_ui_components
...
def start(webcam_mode : WebcamMode, webcam_resolution : str, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	bobacon1_1.globals.face_selector_mode = 'one'
	bobacon1_1.globals.face_analyser_order = 'large-small'
...
def multi_process_capture(source_face : Face, webcam_capture : cv2.VideoCapture, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	with tqdm(desc = wording.get('processing'), unit = 'frame', ascii = ' =', disable = bobacon1_1.globals.log_level in [ 'warn', 'error' ]) as progress:
		with ThreadPoolExecutor(max_workers = bobacon1_1.globals.execution_thread_count) as executor:
			futures = []
