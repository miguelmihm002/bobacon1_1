...
from bobacon.typing import ApplyStateItem, Args, AudioFrame, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
	...
	return\
	{
		'wav2lip_96':
		{
			'hashes':
			{
				'lip_syncer':
				{
					'url': resolve_download_url('models', 'wav2lip_96.hash'),
			...
			'sources':
			{
				'lip_syncer':
				{
					'url': resolve_download_url('models', 'wav2lip_96.onnx'),
		...
		'wav2lip_gan_96':
		{
			'hashes':
			{
				'lip_syncer':
				{
					'url': resolve_download_url('models', 'wav2lip_gan_96.hash'),
			...
			'sources':
			{
				'lip_syncer':
				{
					'url': resolve_download_url('models', 'wav2lip_gan_96.onnx'),
