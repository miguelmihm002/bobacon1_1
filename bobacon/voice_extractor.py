...
from bobacon.typing import Audio, AudioChunk, DownloadScope, InferencePool, ModelOptions, ModelSet
	...
	return\
	{
		'kim_vocal_2':
		{
			'hashes':
			{
				'voice_extractor':
				{
					'url': resolve_download_url('models', 'kim_vocal_2.hash'),
			...
			'sources':
			{
				'voice_extractor':
				{
					'url': resolve_download_url('models', 'kim_vocal_2.onnx'),
